        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    ?>                  
                    <li <?php if ($tempFile == "index.php") {echo 'class="active"'; }?>><a href="index.php"><i class="ti-home"></i> 管理者首頁</a> </li>		 
					<li <?php if ($tempFile == "member.php") {echo 'class="active"'; } ?>><a href="member.php"><i class="ti-control-record"></i> 1.會員資料管理</a></li>	
                    ...
                    <div class="col-lg-12 p-0">
                        <div class="page-header">
							<div class="page-title">
								<h1><?=$_SESSION['sname']?>您好！登入時間：<?=$_SESSION['sLogintime']?></h1>
							</div>
						</div>
                    </div>
